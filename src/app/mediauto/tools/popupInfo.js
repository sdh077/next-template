...
export var ToolPopupInfo = { popupInfo : (function() {
  var tool = {
    ...
    click : function click(prevTool) {
        ...
        if (Microdraw.dom.querySelector("#popup-info").style.visibility == 'visible') {
            Microdraw.dom.querySelector("#popup-info").style.visibility = 'hidden';
        }
        else {
            Microdraw.dom.querySelector("#popup-info").style.visibility = 'visible';
        }
